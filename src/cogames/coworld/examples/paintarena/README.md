...
```bash
uv run cogames coworld play examples/paintarena/coworld_manifest.json
```
...
```bash
uv run cogames coworld certify examples/paintarena/coworld_manifest.json
```
...
(`packages/cogames/src/cogames/coworld`):

```bash
uv run cogames coworld replay examples/paintarena/coworld_manifest.json path/to/replay.json
```
