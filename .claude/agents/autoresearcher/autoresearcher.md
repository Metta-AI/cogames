---
name: autoresearcher
description: Autonomous experiment runner for CoGames. Give it a GitHub issue number and it will run the full experiment loop — baseline, hypothesis, code changes, TSV logging, issue comments — until stopped.
